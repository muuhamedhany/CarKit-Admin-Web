...
import { ArrowLeft, FileText, Eye, CheckCircle, XCircle, User, Shield, Zap, Fingerprint } from 'lucide-react';
                  ...
                  {documents.map((doc, idx) => (
                    ...
                    >
                      <div className="flex items-center gap-4 min-w-0">
                        <div className="w-12 h-12 rounded-xl bg-cyber-pink/5 border border-cyber-pink/10 flex items-center justify-center group-hover:bg-cyber-pink/10 transition-colors shrink-0">
                      ...
                      <a
                        ...
                        className="cyber-button px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest bg-cyber-pink/10 border-cyber-pink/20 text-cyber-pink hover:bg-cyber-pink/20 hover:border-cyber-pink transition-all flex items-center gap-2 cursor-pointer shrink-0"
                      >
            ...
            <div className="flex flex-1 sm:flex-initial gap-3 justify-end">
              ...
              {status !== 'approved' && (
                <button
                  ...
                  disabled={updating}
                  className="flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-[10px] font-black uppercase tracking-[0.3em] bg-green-500/20 text-green-400 border border-green-500/30 hover:bg-green-500/30 hover:border-green-500/50 disabled:opacity-50 group cursor-pointer"
                >
                  <CheckCircle className="w-4 h-4 group-hover:scale-125 transition-transform" />
